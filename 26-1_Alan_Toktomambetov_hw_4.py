...
def start_game():
    boss = Boss(name="Raiden", health=3000, damage=60)

    warrior = Warrior(name="Axel", health=270, damage=80)
    mag = Magic(name="Gerald", health=280, damage=70)
    medic_1 = Medic(name="Andrew", health=200, damage=10, heal_point=20)
    medic_2 = Medic(name="Howkins", health=250, damage=15, heal_point=10)
    berserk = Berserk(name="Carlo", health=300, damage=80)
    thor = Thor(name="Zeus", health=260, damage=80)
    antman = AntMan(name="Johnny", health=int(260), damage=int(70))
