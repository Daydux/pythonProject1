...
iphone = SmartPhone(cpu="Iphone 14 Pro Max", memory=1024, sim_cards_list=["Beeline", "MegaCom", "O!"])
samsung = SmartPhone(cpu="Samsung Galaxy A20", memory=256, sim_cards_list=["Beeline", "MegaCom", "O!"])
...
phone1.call(call_to_number="+996(558)20-33-33", sim_card_number="1-Beeline")

iphone.use_gps(location="Globus")
